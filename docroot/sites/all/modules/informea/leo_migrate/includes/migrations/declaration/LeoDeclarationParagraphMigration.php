...
class LeoDeclarationParagraphMigration extends LeoDefaultNodeMigration {
  ...
  public function __construct(array $arguments) {
    ...
    $this->addSimpleMappings(array(
      'title_field', 'title_field:language', 'field_official_order',
    ));
  ...
  protected function taxonomyFields() {
    return array(
      ...
      'field_declaration_paragraph_type' => 'declaration_paragraph_type',
    );
  }
}
